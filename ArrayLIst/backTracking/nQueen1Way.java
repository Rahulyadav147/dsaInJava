...
public class nQueen1Way {
    ...
    public static boolean placeQueens(char queenGrid[][],int row){
                 // base case 
                 ...
                 for(int col=0;col<queenGrid.length;col++){
                    ...
                    if(isSafe(queenGrid,row,col)){
                        ...
                        if( placeQueens(queenGrid, row+1)){// if one solution exists
                             return true;
                        }
